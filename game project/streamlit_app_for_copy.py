# streamlit_app.py - Streamlit部署入口
import sys
import os

# 添加game_plan目录到Python路径
sys.path.insert(0, os.path.join(os.path.dirname(__file__), 'game_plan'))

try:
    from game_plan.web_interface import main
except ImportError:
    ...
    def main():
        st.set_page_config(page_title="游戏AI Agent", page_icon="🎮", layout="wide")
